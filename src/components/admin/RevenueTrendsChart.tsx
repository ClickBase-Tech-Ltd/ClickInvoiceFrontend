...
export default function RevenueTrendsChart({
  ...
  const lineColor = isMonochrome ? "#0A66C2" : "#0A66C2";
        ...
        {isHistogram ? (
          ...
          <AreaChart data={data} margin={{ top: 18, right: 30, left: 0, bottom: 0 }}>
            {isGradient ? (
              <defs>
                <linearGradient id={gradientId} x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#0A66C2" stopOpacity={0.35} />
          ...
          >
            ...
            <Line
              ...
              dot={isMinimal ? false : { r: 5, fill: "#0A66C2", stroke: "#fff", strokeWidth: 2 }}
              activeDot={isMinimal ? { r: 5 } : { r: 7, stroke: "#0A66C2", strokeWidth: 2 }}
              strokeDasharray={isDotted ? "4 4" : undefined}
            />
          </LineChart>
        )}
