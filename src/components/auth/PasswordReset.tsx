        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 lg:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full py-3 px-4 text-sm font-semibold text-white bg-[#0A66C2] rounded-lg shadow hover:bg-[#0857a8] disabled:opacity-50 disabled:cursor-not-allowed transition"
              >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link
                href="/signin"
                className="font-medium text-[#0A66C2] hover:text-[#0857a8] transition"
              >
                Sign in here
              </Link>
            </p>
