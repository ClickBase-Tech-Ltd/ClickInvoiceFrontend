        ...
        <div className="flex items-center gap-2">
          ...
          {hasNewUsers ? (
            <button
              ...
              className="text-[11px] font-semibold text-gray-500 hover:text-[#0A66C2]"
            >
              Clear
            </button>
          ) : null}
          {onPin ? (
            <button
              ...
              disabled={loading}
              className="text-[11px] font-semibold text-[#0A66C2] hover:underline disabled:cursor-not-allowed disabled:text-gray-400"
            >
              Pin
            </button>
          ) : null}
            ...
            <div key={item.id} className="flex items-start gap-3">
              <div
                className={`mt-1 h-2 w-2 rounded-full ${
                  item.status === "new-user" ? "bg-red-500" : "bg-[#0A66C2]"
                }`}
              />
