  ...
  return (
    <div className="w-full font-sans">
      <button
        ...
        className="mb-3 w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-left transition hover:border-[#0A66C2]/40 dark:border-white/[0.08] dark:bg-gray-900"
      >
        <div className="flex items-center justify-between">
          ...
          <span className="rounded-full bg-[#0A66C2]/10 px-2 py-0.5 text-[11px] font-semibold text-[#0A66C2]">
            USD
          </span>
        </div>
          ...
          <div key={idx} className="w-full">
            {item.isKpi ? (
              <button
                ...
                className="flex flex-col items-start justify-center gap-1 w-full rounded-xl border border-gray-200 bg-white px-3 py-2 text-gray-900 transition hover:border-[#0A66C2]/40 dark:border-white/10 dark:bg-gray-900 dark:text-gray-200"
              >
              ...
              <a
                href={item.href ?? "#"}
                className="flex flex-col items-center justify-center gap-2 w-full rounded-xl border border-gray-200 bg-white py-2 text-[#0A66C2] transition hover:border-[#0A66C2]/40 hover:text-[#0A66C2] dark:border-white/10 dark:bg-gray-900 dark:text-gray-300"
              >
                <div className="w-10 h-10 rounded-full bg-[#0A66C2]/10 flex items-center justify-center text-sm font-bold">
