                        ...
                        <div>
                          <p
                            className={`text-sm font-semibold ${
                              isActive ? "text-[#0A66C2]" : "text-gray-900 dark:text-white"
                            }`}
                          >
                            {userName}
                          </p>
                ...
                <div className="flex flex-wrap items-end gap-2">
                  <div className="min-w-[140px] flex-1">
                    ...
                    <select
                      ...
                      className="mt-1 w-full rounded-2xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 focus:border-[#0A66C2] focus:outline-none focus:ring-2 focus:ring-[#0A66C2]/20 dark:border-white/10 dark:bg-white/5 dark:text-gray-200"
                    >
                  ...
                  (statuses[selectedTicket.ticketId] || selectedTicket.status) === "in_progress" ? (
                    <div className="min-w-[160px] flex-1">
                      ...
                      <select
                        ...
                        className="mt-1 w-full rounded-2xl border border-gray-200 bg-white px-3 py-2 text-xs text-gray-700 focus:border-[#0A66C2] focus:outline-none focus:ring-2 focus:ring-[#0A66C2]/20 dark:border-white/10 dark:bg-white/5 dark:text-gray-200"
                      >
                ...
                (statuses[selectedTicket.ticketId] || selectedTicket.status) === "in_progress" ? (
                  <div className="flex flex-col gap-2">
                    <textarea
                      ...
                      className="w-full min-h-[40px] max-h-[160px] resize-none rounded-2xl border border-gray-200 bg-white px-3 py-2 text-sm leading-relaxed text-gray-700 focus:border-[#0A66C2] focus:outline-none focus:ring-2 focus:ring-[#0A66C2]/20 dark:border-white/10 dark:bg-white/5 dark:text-gray-200"
                    />
                    <div className="flex justify-end">
                      <Button
                        onClick={() => handleReplySubmit(selectedTicket.ticketId)}
                        disabled={!replyMessages[selectedTicket.ticketId]?.trim()}
                        className="px-4 py-2 text-xs sm:px-8 sm:py-3 sm:text-sm !bg-[#0A66C2] !hover:bg-[#084d93] rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Send Reply
                      </Button>
                    </div>
