      ...
      <div className="flex items-start justify-between gap-2 mb-3 select-none cursor-move">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-full border border-gray-200 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-gray-500 hover:text-[#0A66C2] dark:border-white/10 dark:text-gray-400"
          >
            {view === "list" ? "Grid" : "List"}
          </button>
          <button
            ...
            >
              <div className="flex items-start justify-between gap-2">
                ...
                <button
                  ...
                  className="text-[11px] font-semibold text-gray-400 hover:text-[#0A66C2]"
                >
                  Remove
                </button>
