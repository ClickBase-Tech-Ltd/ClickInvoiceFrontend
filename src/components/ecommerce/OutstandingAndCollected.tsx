      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-blue-200 dark:border-blue-800/30 p-5 transition-all duration-300 group overflow-hidden relative">
        ...
        <div className="flex justify-between items-start relative z-10">
          <div className="flex-1">
            <p className="text-xs text-[#0A66C2] dark:text-blue-200 font-medium uppercase tracking-wide">
              Outstanding
            </p>
            ...
            <p className="text-xs text-[#0A66C2] dark:text-blue-300 mt-1">
              Amount yet to receive
            </p>
          </div>

          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#0A66C2] to-[#084d93] dark:from-[#0A66C2] dark:to-[#084d93] flex items-center justify-center text-white transition-transform duration-300">
