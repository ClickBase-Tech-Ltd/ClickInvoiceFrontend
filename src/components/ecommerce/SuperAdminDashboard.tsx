  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-gray-200/70 bg-white p-5 sm:p-6 shadow-[0_1px_0_rgba(16,24,40,0.04)] dark:border-white/10 dark:bg-gray-900">
        ...
        <div className="pointer-events-none absolute -left-16 -bottom-20 h-40 w-40 rounded-full bg-[#0A66C2]/10 blur-3xl" />
                  ...
                  <button
                    ...
                    className={
                      analyticsRange === option.value
                        ? "rounded-full bg-[#0A66C2] px-3 py-1 text-white"
            ...
            <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:justify-end">
                    ...
                    <button
                      ...
                      className={
                        analyticsStyle === option.value
                          ? "rounded-full bg-[#0A66C2] px-2.5 py-1 text-white"
              ...
              <div className="flex w-full items-center gap-2 sm:hidden">
                ...
                <select
                  ...
                  className="w-full rounded-full border border-gray-200 bg-white px-3 py-1 text-xs text-gray-600 focus:border-[#0A66C2] focus:outline-none focus:ring-2 focus:ring-[#0A66C2]/20 dark:border-white/10 dark:bg-gray-900 dark:text-gray-300"
                >
              ...
              <span className="rounded-full bg-[#0A66C2]/10 px-2.5 py-1 text-xs font-semibold text-[#0A66C2]">Live</span>
              <button
                type="button"
                onClick={() => {
                ...
                className="rounded-full border border-gray-200 px-3 py-1 text-xs font-semibold text-gray-600 hover:border-[#0A66C2]/40 hover:text-[#0A66C2] dark:border-white/10 dark:text-gray-300"
              >
                Insights
              </button>
              <button className="rounded-full border border-gray-200 px-3 py-1 text-xs font-semibold text-gray-600 hover:border-[#0A66C2]/40 hover:text-[#0A66C2] dark:border-white/10 dark:text-gray-300">
                Export
              </button>
            </div>
          </div>
