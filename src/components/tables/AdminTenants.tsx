...
export default function AdminTenants() {
  ...
  const statusBadgeColor = (status: Tenant["status"]) => {
    switch (status) {
      case "active":
        return "success";
      case "inactive":
  ...
  return (
    <div className="relative min-h-screen">
      <div className="space-y-6 py-6 px-4 md:px-6 lg:px-8">
        {/* Page Header - Matches Subscriptions Page */}
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400">
            Total: <span className="font-medium">{tenants.length}</span>
          </div>
        </div>

        {/* Table - EXACTLY like Subscriptions Page */}
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <span
                              className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium ${
                                ...
                                }[statusBadgeColor(tenant.status)]
                              }`}
                            >
