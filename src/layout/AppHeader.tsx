...
const AppHeader: React.FC = () => {
  ...
  const handleTenantSwitch = async (tenant: Tenant) => {
    ...
    try {
      ...
      setMobileTenantDropdownOpen(false);
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        ...
        !(event.target as HTMLElement).closest(".tenant-switcher-button")
      ) {
        setTenantDropdownOpen(false);
      }
    };
                ...
                {currentTenant && (
                  <div className="border-b dark:border-gray-700 p-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Current Tenant</p>
                    ...
                    >
                      ...
                      <svg
                        className={`h-4 w-4 transition-transform ${
                          isMobileTenantDropdownOpen ? "rotate-180" : ""
                        }`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
