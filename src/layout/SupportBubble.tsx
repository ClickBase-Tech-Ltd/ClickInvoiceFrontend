  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex items-center gap-3">
      ...
      <button
        ...
        className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-black/10 bg-[#0A66C2] text-white shadow-[0_12px_30px_rgba(10,102,194,0.35)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#084e96] hover:shadow-[0_16px_40px_rgba(10,102,194,0.45)] focus:outline-none focus:ring-2 focus:ring-[#0A66C2]/30"
        style={{ animation: "bubbleIn 260ms ease-out" }}
      >
        <span className="absolute -inset-2 rounded-full bg-[#0A66C2]/20 opacity-0 blur-xl transition-opacity duration-300 group-hover:opacity-100" />
